...
from ....glob.basic_keys import alphabet
from .. import utils
from ....imported.homophones import raise_homophones

from .formatters import CAMELCASE, formatted_text
...
select_verbs = {
    ...
    "comment | cast": [idea("action CommentByLineComment")],
...
keymap.update(
    {
        ...
        # Search
        "(search (everywhere | all)) | master": idea("action SearchEverywhere"),
        ...
        "run (again | application)": idea("action Run"),
        # Recording
        ...
        "(go next tab) | steppy": idea("action NextTab"),
        "(go last tab) | steffy": idea("action PreviousTab"),
